...
loco()
 ...
 document.querySelector("#page2>h1").textContent.split(" ").forEach(function(dets){
   text += `<span> ${dets} </span>`;
   document.querySelector("#page2>h1").innerHTML = text;
 })
...
document.querySelector("#page4>h1").textContent.split(" ").forEach(function(dets){
  text2 += `<span> ${dets} </span>`;
  document.querySelector("#page4>h1").innerHTML = text2;
})
...
document.querySelector("#page6>h1").textContent.split(" ").forEach(function(dets){
  text3 += `<span> ${dets} </span>`;
  document.querySelector("#page6>h1").innerHTML = text3;
})
let text4= ""

document.querySelector("#page6>h2").textContent.split(" ").forEach(function(dets){
  text4 += `<span> ${dets} </span>`;
  document.querySelector("#page6>h2").innerHTML = text4;
})
